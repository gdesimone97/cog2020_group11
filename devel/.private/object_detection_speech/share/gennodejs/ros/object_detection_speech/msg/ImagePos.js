...
// (in-package object_detection_speech.msg)
...
class ImagePos {
  ...
  static datatype() {
    ...
    return 'object_detection_speech/ImagePos';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '73eebf94e6b1aa3fd1a240462bd30d03';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ImagePos(null);
