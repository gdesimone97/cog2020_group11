...
"""autogenerated by genpy from object_detection_speech/ImagePos.msg. Do not edit."""
import sys
...
class ImagePos(genpy.Message):
  _md5sum = "73eebf94e6b1aa3fd1a240462bd30d03"
  _type = "object_detection_speech/ImagePos"
...
"""
  __slots__ = ['pos','image']
  _slot_types = ['int8','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImagePos, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_b3I().pack(_x.pos, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pos, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs,) = _get_struct_b3I().unpack(str[start:end])
      start = end
      end += 4
